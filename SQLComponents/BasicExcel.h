...
// Version 3.2 (03.04.2012, Edwig Huisman)
  // - Added Worksheet::CellValue function for easy formatted retrieval
...
struct CODE
{
  enum 
  {
      ...
      XLS_PROTECT=0x0012, 		//Whether worksheet or a workbook is protected against modification.
      ...
      XLS_HLINK=0x01B8,			//One cell address or a cell range where all cells contain the same hyperlink.
...
public: // File functions.
  ...
  bool  Load(const char* filename,bool readonly = false);	///< Load an Excel workbook from a file.
  bool  Load(const wchar_t* filename,bool readonly = false);	///< Load an Excel workbook from a file.
...
private: // Functions to read and write raw Excel format.
  ...
  void    SetError(char* p_error) { error_ = p_error;};
